...
namespace RobotService.Models
{
    public abstract class Robot : IRobot
    {
        ...
        public IReadOnlyCollection<int> InterfaceStandards
        {
            ...
            private set => interfaceStandards.AsReadOnly();
        }

        public void Eating(int minutes)
        {
            int produseEnergy = ConvertionCapacityIndex * minutes;

            BatteryLevel += produseEnergy;
        ...
        public override string ToString()
        {
            ...
            string[] typeArg = type.Split(".").ToArray();
            string typeOrg = typeArg[2];

            sb.AppendLine($"{typeOrg} {Model}:");
